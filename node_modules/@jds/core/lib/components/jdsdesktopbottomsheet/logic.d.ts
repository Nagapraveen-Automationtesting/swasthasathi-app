...
import { JDSDesktopBottomSheetProps } from './generated';
export interface BottomSheetProps extends Omit<JDSDesktopBottomSheetProps, 'height' | 'primaryCTA' | 'secondaryCTA' | 'onBack' | 'label'> {
    primaryCTA?: string | {
        title: string;
